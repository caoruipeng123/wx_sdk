...
namespace WxSdk
{
    internal static class ApiHelper
    {
        ...
        /// <returns></returns>
        internal static T GetResult<T>(string returnText)
        {
            if (returnText.Contains("errcode"))
            {
                ...
                {
                    throw new ErrorJsonResultException(string.Format("微信Post请求发生错误！错误代码：{0}，说明：{1}", (int)errorResult.ErrCode, errorResult.ErrMsg), null, errorResult);
                }
            }
